...
function FrontPage() {
    return (
        <div className="frontPageMainDiv">
            ...
            <p>Lähtökohtana olen käyttänyt Discogsin mediaanihintaa. Osa näistä levyistä on huomattavan hyvässä kunnossa, jolloin olen laittanut hinnan hieman ylemmäksi. Muutamassa tapauksessa jopa selvästi korkeammaksi. Mutta jokaine hintahan on ostajan harkittavissa ja koska tällä kertaa myyn pakon edessä omia levyjäni, niin <b><u>EI ALENNUKSIA !!!</u></b> eli jos olet ostamassa, niin älä laske budjettiasi alennusten varaan. Tämä on selkeä pelin henki (SORRY !!!) ja koskee kaikkia.</p>

            <h2 className="homePageTitles">Discogs numero</h2>
            <p>Jokaisella levyllä tuolla Discogsissa on oma numeronsa, joka löytyy joka kohteen kohdalla. Aiemmin kun olen näitä levyjä myynyt, niin usein kysytään, että mikä painos. Nyt pystyt itse tsekkaamaan asian klikkaamalla levyn discogs numeroa levylistassa, niin pääset suoraan levyn discogs-sivulle. </p>

            <h2 className="homePageTitles">Levyjen kunto</h2>
            <p>Kunnot on arvioitu pääosin vain visuaalisesti. Ensimmäinen sarake on levy <b>(Rec)</b>, toinen kansi <b>(PS)</b>. Jos se on tyhjä, niin ei kantta <b>(NOPS)</b><br></br><br></br>
